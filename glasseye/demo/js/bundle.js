var ChartModule = (function (exports) {
  'use strict';
  ...
  function linechart(processed_data, div, size) {
      ...
      var xScale = linear()
          .domain([
          (_a = min(processed_data, function (d) { return d.x; })) !== null && _a !== undefined ? _a : 0,
          (_b = max(processed_data, function (d) { return d.x; })) !== null && _b !== undefined ? _b : 0,
      ])
          .range([margin.left, width - margin.right]);
      var yScale = linear()
          .domain([
          0,
          (_c = max(processed_data, function (d) { return d.y; })) !== null && _c !== undefined ? _c : 0,
      ])
